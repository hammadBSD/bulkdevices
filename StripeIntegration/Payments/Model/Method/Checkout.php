...
class Checkout extends \Magento\Payment\Model\Method\AbstractMethod
{
    ...
    public function initialize($paymentAction, $stateObject)
    {
        ...
        try
        {
            ...
            else if ($this->checkoutSessionHelper->hasChanged($checkoutSession, $params))
            {
            ...
            if ($checkoutSessionModel->getOrderIncrementId() && $checkoutSessionModel->getOrderIncrementId() != $order->getIncrementId())
            {
                $oldOrder = $this->helper->loadOrderByIncrementId($checkoutSessionModel->getOrderIncrementId());
                ...
                $this->helper->cancelOrCloseOrder($oldOrder);
            }
