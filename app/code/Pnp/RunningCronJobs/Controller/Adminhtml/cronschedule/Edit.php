...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Pnp_RunningCronJobs::Cronschedule')
            ->addBreadcrumb(__('Pnp RunningCronJobs'), __('Pnp RunningCronJobs'))
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('Pnp\RunningCronJobs\Model\Cronschedule');
        ...
        $this->_coreRegistry->register('cronschedule', $model);

        // 5. Build edit form
        /** @var \Magento\Backend\Model\View\Result\Page $resultPage */
        $resultPage = $this->_initAction();
        $resultPage->setActiveMenu('Pnp_RunningCronJobs::cronschedule');
        $resultPage->addBreadcrumb(__('Pnp'), __('Pnp'));
