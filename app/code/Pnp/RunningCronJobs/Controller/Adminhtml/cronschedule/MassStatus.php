...
class MassStatus extends \Magento\Backend\App\Action
{
    ...
    {
        $itemIds = $this->getRequest()->getParam('cronschedule');
        if (!is_array($itemIds) || empty($itemIds)) {
            ...
            try {
                ...
                foreach ($itemIds as $postId) {
                    $post = $this->_objectManager->get('Pnp\RunningCronJobs\Model\Cronschedule')->load($postId);
        ...
        return $this->resultRedirectFactory->create()->setPath('runningcronjobs/*/index');
    }
