...
use BSD\ProductAttributes\Model\Config\AttributeWithValue02Options;
...
class AddAttributeWithValue02ProductAttributes implements DataPatchInterface
{
    ...
    public function apply(): void
    {
        ...
        foreach (AttributeWithValue02Options::getDefinitions() as $code => $definition) {
