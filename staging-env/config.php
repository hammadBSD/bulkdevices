 ...
 * Hyvä module map + staging-only extensions from legacy Luma config.
 * Copy to app/etc/config.php after composer install (before setup:upgrade).
 */
return [
    'modules' => [
        'Magento_Store' => 1,
        ...
        'Aalogics_CartItem' => 1,
        'Aalogics_CategoryText' => 1,
        'Aalogics_GoogleReviews' => 1,
        'Aalogics_Uet' => 1,
        'Aitoc_Core' => 1,
        'Aitoc_Smtp' => 1,
        'BSD_Banner' => 1,
        ...
        'Pnp_DisableFreeShippingByWeight' => 1,
        'Pnp_ImportGadget' => 1,
        'Pnp_RunningCronJobs' => 1,
        'RLTSquare_CheckoutFieldsSortOrder' => 1,
